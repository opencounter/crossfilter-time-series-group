 ...
 *                                     time-series buckets.
 */
export default function TimeSeriesGroup(group, interval, defaultValue) {
  defaultValue = defaultValue || 0;
  var next = interval.offset ?
    function(current) { return interval.offset(current, 1); } :
    function(current) { return current + interval; };
